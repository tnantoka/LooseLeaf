...
var Deferred = require('./ext/jsdeferred').Deferred;
...
// Simple CSRF protection by session id
// TOOD: use http://senchalabs.github.com/connect/middleware-csrf.html
function checkToken(req) {
  return req.session && req.session.id == req.body.token;
}

exports.loadFiles = function(dir, type) {
